...
public final class ReactorService2Grpc {
    ...
    public static final class ReactorService2Stub extends io.grpc.stub.AbstractStub<ReactorService2Stub> {
        ...
        public reactor.core.publisher.Mono<com.assessement.service2.Service2OuterClass.Service2Reply> getService2(reactor.core.publisher.Mono<com.assessement.service2.Service2OuterClass.NoParams> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.oneToOne(reactorRequest, delegateStub::getService2, getCallOptions());
        }

        public reactor.core.publisher.Mono<com.assessement.service2.Service2OuterClass.Service2Reply> getService2(com.assessement.service2.Service2OuterClass.NoParams reactorRequest) {
    ...
    public static abstract class Service2ImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Mono<com.assessement.service2.Service2OuterClass.Service2Reply> getService2(reactor.core.publisher.Mono<com.assessement.service2.Service2OuterClass.NoParams> request) {
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            com.assessement.service2.Service2Grpc.getGetService2Method(),
                            asyncUnaryCall(
                                    new MethodHandlers<
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_GET_SERVICE2:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((com.assessement.service2.Service2OuterClass.NoParams) request,
